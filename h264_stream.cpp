...
void read_seq_parameter_set_rbsp(h264_stream_t* h, bs_t* b)
{
    ...
    if( sps->vui_parameters_present_flag )
    {
        ...
        /* ע�������֡�ʼ��㻹�����⣬x264����25fps��time_scaleΪ50��num_units_in_tickΪ1�������50fps
        ����˵������nuit_field_based_flagΪ1ʱ���ٳ���2����˵x264����ֵ����Ϊ0.
        ��ַ��http://forum.doom9.org/showthread.php?t=153019
        */
...
void read_pic_parameter_set_rbsp(h264_stream_t* h, bs_t* b)
{
    ...
    //2005��汾�˴�Ϊpps->pic_order_present_flag��2013��汾Ϊbottom_field_pic_order_in_frame_present_flag
